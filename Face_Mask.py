...
def detect_eye(img):
    ...
    haar_cascade = cv2.CascadeClassifier('C:\opencv\opencv\sources\data\haarcascades\haarcascade_eye_tree_eyeglasses.xml')
...
def detect_face(img, mask, ratio_w_h_mask):
    ...
    haar_cascade = cv2.CascadeClassifier('C:\opencv\opencv\sources\data\haarcascades\haarcascade_frontalface_alt2.xml')
